  ...
  return (
    <div className="w-full h-screen relative overflow-hidden bg-gradient-to-br from-[#222829] via-[#2a2f32] to-[#1a1f23]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute w-2 h-2 bg-[#49c5b6] rounded-full animate-float-1"
          style={{ top: "20%", left: "10%" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-[#49c5b6]/60 rounded-full animate-float-2"
          style={{ top: "40%", left: "80%" }}
        ></div>
        <div
          className="absolute w-3 h-3 bg-[#49c5b6]/40 rounded-full animate-float-3"
          style={{ top: "60%", left: "20%" }}
        ></div>
        <div
          className="absolute w-1.5 h-1.5 bg-[#49c5b6]/80 rounded-full animate-float-1"
          style={{ top: "80%", left: "70%" }}
        ></div>
        <div
          className="absolute w-2 h-2 bg-[#49c5b6]/50 rounded-full animate-float-2"
          style={{ top: "30%", left: "60%" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-[#49c5b6] rounded-full animate-float-3"
        ...
        <div className="hidden lg:block">
          ...
          >
            <div className="bg-[#49c5b6]/5 border border-[#49c5b6]/20 rounded-lg px-3 py-1.5 backdrop-blur-sm">
              <span className="text-[#49c5b6]/70 font-medium text-sm">
                React Js
              </span>
            </div>
          </div>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center font-poppins z-20 px-4">
        <h1
          className="text-4xl md:text-6xl lg:text-8xl mb-4 text-white animate-fade-in-up"
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-8 animate-fade-in-up animation-delay-200">
          Currently Looking for job opportunities in the MERN Stack. <br />
        </p>
        ...
        <div className="mb-8 animate-fade-in-up animation-delay-300 relative z-30">
          ...
          >
            ...
            <div className="relative flex items-center gap-3">
              <svg
                className="w-5 h-5 text-[#49c5b6] group-hover:rotate-12 transition-transform duration-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div
                className={`w-5 h-5 transition-transform duration-300 ${showProfiles ? "rotate-180" : ""}`}
              >
                <svg
                  className="w-full h-full text-[#49c5b6]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div
          className={`transition-all duration-700 ease-out ${showProfiles ? "mb-8 lg:mb-6" : "mb-6"} ${showProfiles ? "opacity-100 transform translate-y-0 max-h-96" : "opacity-0 transform translate-y-8 pointer-events-none max-h-0 overflow-hidden"}`}
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {/* GitHub */}
            <a
              href="https://github.com/ashiq012"
              target="_blank"
            ...
            >
              <div className="flex flex-col items-center">
                <svg
                  className="w-8 h-8 text-[#49c5b6]/80 group-hover:text-[#49c5b6] transition-colors mb-2"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <span className="text-[#49c5b6]/60 text-xs">
                  Recent Projects
                </span>
                <div className="absolute -top-3 -right-1 bg-gradient-to-r from-yellow-400 to-yellow-500 text-black text-xs font-bold px-1.5 py-1 rounded-full shadow-lg z-10">
                  Coming Soon
            ...
            {/* updataed Resume */}
            <a
              href="https://drive.google.com/file/d/1DrVIwIcHrtOzSuKuwgeu2aY9Pzb-DW6Z/view?usp=drive_link"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative bg-[#49c5b6]/5 hover:bg-[#49c5b6]/10 border border-[#49c5b6]/20 hover:border-[#49c5b6]/40 rounded-lg p-4 backdrop-blur-sm transition-all duration-300 hover:transform hover:scale-105"
            >
              ...
              <div className="flex flex-col items-center">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M7.71 3.5 1.15 14.8a1.5 1.5 0 0 0 0 1.5l3.3 5.7a1.5 1.5 0 0 0 1.3.75h12.5a1.5 1.5 0 0 0 1.3-.75l3.3-5.7a1.5 1.5 0 0 0 0-1.5L16.29 3.5a1.5 1.5 0 0 0-1.3-.75H9.01a1.5 1.5 0 0 0-1.3.75ZM8.6 5h6.8l5.2 9H13.8L8.6 5Zm-1.2 2.1L12.6 16H4.8l2.6-4.5L7.4 7.1ZM14 16h6.2l-2.6 4.5H11.4L14 16Z" />
                </svg>
                <span className="text-white font-medium text-sm mb-1">
                  Resume
                </span>
                <span className="text-[#49c5b6]/60 text-xs">link</span>
              </div>
            </a>
          </div>
        </div>
        ...
        <div
          className={`flex flex-wrap justify-center gap-2 md:gap-3 lg:hidden max-w-sm md:max-w-lg animate-fade-in-up animation-delay-400 ${showProfiles ? "mt-4" : ""}`}
        >
          {[].map((skill, index) => (
            <div
              key={skill}
            ...
            >
              <span className="text-[#49c5b6]/60 font-medium text-xs md:text-sm">
                {skill}
              </span>
            </div>
          ))}
